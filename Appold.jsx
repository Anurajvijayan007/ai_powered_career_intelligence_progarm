          ...
          {!hasResult ? (
            ...
            <>
              ...
              <div style={s.accuracyCard}>
                <div style={s.accRow}>
                  <span style={s.accLabel}>Model</span>
                  <span style={s.accVal}>Logistic Regression</span>
                </div>
                <div style={s.accRow}>
                  <span style={s.accLabel}>Per-label Accuracy</span>
                  <span style={{ ...s.accVal, color: '#34d399' }}>~95.4%</span>
                </div>
                <div style={s.accRow}>
                  <span style={s.accLabel}>Subset Accuracy</span>
                  <span style={{ ...s.accVal, color: '#fbbf24' }}>~52.5%</span>
                </div>
                <div style={s.accRow}>
                  <span style={s.accLabel}>Labels</span>
                  <span style={s.accVal}>13 job classes</span>
                </div>
              </div>
            </>
          )}
...
const s = {
  ...
  accRow: {
    ...
    padding: '6px 0', borderBottom: '1px solid rgba(79,70,229,0.15)',
  },
  accLabel: { color: '#94a3b8', fontSize: '0.85rem' },
  accVal: { color: '#fff', fontWeight: '600', fontSize: '0.85rem' },
};
